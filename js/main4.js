   // ==================== PRELOADER ANIMATION ====================
        ...
        // ==================== PORTFOLIO FILTER ====================
        const filterButtons = document.querySelectorAll('.portfoliopage-filter-btn');
        const portfolioCards = document.querySelectorAll('.portfoliopage-card');
        ...
        document.querySelectorAll('.portfoliopage-card').forEach(card => {
